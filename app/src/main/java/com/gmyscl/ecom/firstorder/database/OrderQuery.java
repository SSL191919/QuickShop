...
import com.gmyscl.ecom.firstorder.buyprocess.BuyNowModel;
import com.gmyscl.ecom.firstorder.buyprocess.ContinueShopping;
...
import static com.gmyscl.ecom.firstorder.database.StaticValues.COD_MODE;
                ...
                public void onComplete(@NonNull Task <DocumentSnapshot> task) {
                    if (task.isSuccessful()){
                        if ( ! task.getResult().contains( "order_id" ) ){
                            ...
                            orderDetailMap.put( "delivered_by", "" );
                            orderDetailMap.put( "delivery_date_day", orderDateDay );
                            orderDetailMap.put( "delivery_time", orderTime );

                            if (DBquery.userInformationList.size() > 0){
                                orderDetailMap.put( "user_phone", DBquery.userInformationList.get( 2 ) );
                            }else{
                                    ...
                                    .addOnCompleteListener( new OnCompleteListener <Void>() {
                                        ...
                                        public void onComplete(@NonNull Task <Void> task) {
                                            ...
                                            if (task.isSuccessful()){
                                                ...
                                                if ( payMode == COD_MODE ){
                                                    // step 7 : PayMode COD gmyscl to (step 12) :
                                                    // PayMode is COD...
                                                ...
                                                // step 5 : Task is failed then gmyscl back (step 1)...
                                                isOrderIdGenerated = false;
                                            }
                        ...
                        // step 3 : Means - Oder ID already exist then gmyscl Back (step 1) to New Order ID...
                    }else{
                        // Tast failed...
                        isOrderIdGenerated = false;
                    }
...
//                                    showToast( "Payment Transaction response " + inResponse.toString() );
                    ...
                    public void clientAuthenticationFailed(String inErrorMessage) {
                        showToast(  context, "Authentication failed: Server error" + inErrorMessage );
                    }
                    @Override
                    ...
                    public void onErrorLoadingWebPage(int iniErrorCode, String inErrorMessage, String inFailingUrl) {
                        showToast( context, "Unable to load webpage " + inErrorMessage );
                    }
                    @Override
