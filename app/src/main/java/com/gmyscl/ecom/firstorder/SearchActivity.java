            ...
            public boolean onQueryTextSubmit(final String query) {
                ...
                for ( final String tag : tags ){
                    FirebaseFirestore.getInstance().collection( "PRODUCTS" )
                            .whereEqualTo( "area_code", StaticValues.userAreaCode )
                        ...
                        public void onComplete(@NonNull Task <QuerySnapshot> task) {
                            if (task.isSuccessful()){
                                ...
                                // error...
                                dialog.dismiss();
                                Toast.makeText( SearchActivity.this, "Failed ! Product Not found.!", Toast.LENGTH_SHORT ).show();
                            }
                        }
                    } );
...
//                            dialog.dismiss();
//                            Toast.makeText( SearchActivity.this, "Failed.! Not found.!", Toast.LENGTH_SHORT ).show();
//                        }
//                    } );
