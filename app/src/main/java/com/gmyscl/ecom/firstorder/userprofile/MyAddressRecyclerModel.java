...
public class MyAddressRecyclerModel {
    ...
    public MyAddressRecyclerModel( String addUserName, String addHNo, String addColony, String addCity, String addState, String addAreaCode, String addLandmark, String areaKeyCode) {
        this.addUserName = addUserName;
        this.addHNo = addHNo;
        this.addColony = addColony;
        this.addCity = addCity;
    ...
    public String getAreaKeyCode() {
        return areaKeyCode;
    }

    public void setAreaKeyCode(String areaKeyCode) {
        this.areaKeyCode = areaKeyCode;
    }
